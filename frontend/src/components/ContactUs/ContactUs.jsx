...
const ContactUs = () => {
  const quickContact = [
    ...
    { icon: "📍", label: "Visit Us", value: "123 Premium Street", sub: "Free Parking" },
          ...
          <div className="w-full mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              {quickContact.map((contact, index) => (
                <div key={index} className="bg-white rounded-xl p-6 border border-[#D2B48C] hover:border-[#006400] transition-all duration-300 hover:shadow-lg">
                  ...
                  <p className="text-[#964B00] text-sm">
                    {contact.sub}
                  </p>
                </div>
              ))}
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {services.map((service, index) => (
              <div key={index} className="bg-gradient-to-br from-[#F5F5DC] to-[#D2B48C] rounded-2xl p-6 border border-[#D2B48C] hover:border-[#006400] transition-all duration-300 group hover:shadow-lg">
                ...
                <ul className="space-y-2">
                  {service.features.map((feature, featureIndex) => (
                    <li key={featureIndex} className="flex items-center gap-2 text-sm text-[#452B1F]">
      ...
      <section className="py-16 bg-gradient-to-br from-[#F5F5DC] to-[#D2B48C]">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {faqs.map((faq, index) => (
              <div key={index} className="bg-white rounded-xl p-5 border border-[#D2B48C] hover:border-[#006400] transition-all duration-300 hover:shadow-lg">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <div className="bg-white/20 backdrop-blur-sm rounded-xl p-4 border border-[#D2B48C]">
                <div className="text-[#D2B48C] text-xs font-semibold mb-1">Emergency Helpline</div>
