            ...
            <div className="space-y-8 order-2 lg:order-1">
              ...
              <div className="space-y-4">
                <p className="text-lg text-[#452B1F] leading-relaxed">
                  Welcome to <strong className="text-[#006400]">Mutton Master</strong>, where 
            ...
            <div className="relative order-1 lg:order-2">
              <div className="relative bg-white rounded-2xl border border-[#D2B48C] p-4 shadow-xl">
                ...
                <div className="absolute bottom-4 left-4 bg-white/95 px-3 py-1 rounded-lg border border-[#D2B48C] shadow-lg">
                  <div className="text-center">
                    <div className="text-xs text-[#006400] font-semibold">Award Winning</div>
                    <div className="text-sm font-bold flex items-center gap-1">
                      Quality <span className="text-[#964B00]">⭐</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-gradient-to-br from-[#F5F5DC] to-[#D2B48C] rounded-2xl p-6 border border-[#D2B48C]">
              <div className="flex items-center gap-4 mb-4">
                ...
                <h3 className="text-2xl font-black text-[#452B1F]">Our Vision</h3>
              </div>
            ...
            <div className="bg-gradient-to-br from-[#F5F5DC] to-[#D2B48C] rounded-2xl p-6 border border-[#D2B48C]">
              <div className="flex items-center gap-4 mb-4">
                ...
                <h3 className="text-2xl font-black text-[#452B1F]">Our Mission</h3>
              </div>
              <p className="text-[#452B1F] leading-relaxed mb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {visionPoints.map((point, index) => (
              <div key={index} className="bg-white rounded-xl p-4 border border-[#D2B48C] hover:border-[#006400] transition-all duration-300">
        ...
        <div className="container mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {[
              ...
              <div key={index} className="flex items-center gap-2 bg-[#F5F5DC] px-3 py-2 rounded-full border border-[#D2B48C]">
                <span className="text-sm">{badge.icon}</span>
                <span className="text-xs font-semibold text-[#006400]">{badge.text}</span>
              </div>
            ))}
          </div>
        </div>
